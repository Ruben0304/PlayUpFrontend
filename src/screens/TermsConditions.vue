    ...
    <div class="container mx-auto max-w-4xl px-4">
      <div class="relative overflow-hidden bg-background-600 rounded-xl p-8 shadow-2xl" data-aos="fade-up">
        ...
        <div class="relative z-10">
          ...
          <h1 class="text-4xl font-bold mb-8 text-primary-500">Términos y Condiciones</h1>
          ...
          <div class="space-y-8">
            ...
            <section class="space-y-4">
              <h2 class="text-2xl font-bold text-primary-500">1. Uso de la Aplicación</h2>
              <div class="pl-4 space-y-4">
                <h3 class="text-xl font-semibold text-white">1.1. Uso Adecuado</h3>
                <p class="text-gray-300">Usted se compromete a utilizar la Aplicación de manera legal y ética, sin
                  infringir los derechos de terceros ni violar la ley.</p>

                <h3 class="text-xl font-semibold text-white">1.2. Cuentas de Usuario</h3>
                <p class="text-gray-300">Al crear una cuenta en la Aplicación, usted es responsable de mantener la
                  confidencialidad de su nombre de usuario y contraseña. Cualquier actividad realizada desde su cuenta
                  se considerará realizada por usted.</p>
              </div>
            </section>

            <section class="space-y-4">
              <h2 class="text-2xl font-bold text-primary-500">2. Privacidad</h2>
              <p class="text-gray-300">Su uso de la Aplicación también está sujeto a nuestra Política de Privacidad, la
                cual regula la recopilación y el tratamiento de sus datos personales. Por favor, lea y comprenda nuestra
                Política de Privacidad.</p>
            </section>

            <section class="space-y-4">
              <h2 class="text-2xl font-bold text-primary-500">3. Contenido de la Aplicación</h2>
              <div class="pl-4 space-y-4">
            ...
            <section class="space-y-4">
              <h2 class="text-2xl font-bold text-primary-500">5. Terminación</h2>
              <div class="pl-4 space-y-4">
                <h3 class="text-xl font-semibold text-white">5.1. Terminación por Usted</h3>
            ...
            <section class="space-y-4">
              <h2 class="text-2xl font-bold text-primary-500">8. Ley Aplicable</h2>
              <p class="text-gray-300">Estos Términos se rigen por las leyes vigentes en [Jurisdicción]. Cualquier
                disputa que surja en relación con estos Términos se someterá a la jurisdicción exclusiva de los
                tribunales de [Jurisdicción].</p>
            </section>

            <section class="space-y-4">
              <h2 class="text-2xl font-bold text-primary-500">9. Contacto</h2>
              <p class="text-gray-300">Si tiene preguntas o inquietudes relacionadas con estos Términos y Condiciones,
                no dude en ponerse en contacto con nosotros a través de [dirección de correo electrónico o número de
