      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div><h4 class="text-lg font-semibold mb-4">{{ $t('footer.productTitle') }}</h4>
          <ul class="space-y-2 text-gray-400">
            <li><a href="#features" class="hover:text-orange-500 transition-colors">{{ $t('footer.featuresLink') }}</a>
            </li>
            <li><a href="#tournaments" class="hover:text-orange-500 transition-colors">{{
                $t('footer.tournamentsLink')
              }}</a></li>
            <li><a href="#players" class="hover:text-orange-500 transition-colors">{{ $t('footer.playersLink') }}</a>
            </li>
            <li><a href="#stats" class="hover:text-orange-500 transition-colors">{{ $t('footer.statsLink') }}</a></li>
          </ul>
        </div>
